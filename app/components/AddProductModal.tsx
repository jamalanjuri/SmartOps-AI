...
export default function AddProductModal({
  ...
  const handleSave = async () => {
    ...
    try {
       ...
       *
       * These properties match the Product
       * interface in productService.ts.
       */
      ...
      <div className="max-h-[95vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Add a new product to SmartOps inventory.
              </p>
            </div>
          </div>
        ...
        <div className="sticky bottom-0 flex justify-end gap-4 border-t bg-white p-6">
          ...
          <button
            ...
            onClick={handleSave}
            disabled={saving}
            className="inline-flex min-w-40 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 font-medium text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {saving ? (
              <>
